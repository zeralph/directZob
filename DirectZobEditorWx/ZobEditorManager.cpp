...
void ZobEditorManager::UpdateEngine()
{
	if (m_init)
	{
		...
		{
			ZobComponentSprite* zs = (*iterL)->GetComponent<ZobComponentSprite>();
			if (zs)
			{
				ZobObject* z = zs->GetZobObject();
				ZobVector3 vd = c->GetWorldPosition() - z->GetWorldPosition();
				float d = vd.sqrtLength();
				d /= 12.0f;
				zs->SetSpriteScale(d);
				//zs->se
			}
		}
		std::vector<Camera*> vc = ZobEntity::GetEntities<Camera>();
		std::vector<Camera*>::const_iterator iterC;
		for (iterC = vc.begin(); iterC != vc.end(); iterC++)
		{
			ZobComponentSprite* zs = (*iterC)->GetComponent<ZobComponentSprite>();
			if (zs)
			{
				ZobObject* z = zs->GetZobObject();
				ZobVector3 vd = c->GetWorldPosition() - z->GetWorldPosition();
...
void ZobEditorManager::OnKeyDown(wxKeyEvent& event)
{
...
void ZobEditorManager::UpdateView()
{
	...
	if (m_lastMouseEvent.ButtonIsDown(wxMouseButton::wxMOUSE_BTN_LEFT))
	{
		...
		Camera* c = DirectZob::GetInstance()->GetCameraManager()->GetCurrentCamera();
		float d = c->GetWorldPosition().sqrtLength();
		x *= d / 10.0f;
		y *= d / 10.0f;
		if (c)
		{
...
void ZobEditorManager::OnNewScene()
{
	...
	Triangle::RenderOptions::eLightMode lm = Triangle::RenderOptions::eLightMode_none;
	...
	m_componentTranslateX->GetRenderOptions()->colorMode = Triangle::RenderOptions::eColorMode_blend;
	...
	m_componentTranslateY->GetRenderOptions()->colorMode = Triangle::RenderOptions::eColorMode_blend;
	...
	m_componentTranslateZ->GetRenderOptions()->colorMode = Triangle::RenderOptions::eColorMode_blend;
	...
	m_componentRotateX->GetRenderOptions()->colorMode = Triangle::RenderOptions::eColorMode_blend;
	...
	m_componentRotateY->GetRenderOptions()->colorMode = Triangle::RenderOptions::eColorMode_blend;
	...
	m_componentRotateZ->GetRenderOptions()->colorMode = Triangle::RenderOptions::eColorMode_blend;
...
void ZobEditorManager::SetSelectedObject(ZobObject* z)
{
	if (m_selectedObject)
	{
		...
		if (zm)
		{
			zm->GetRenderOptions()->color = ZobColor::Black;
		}
	...
	if (z)
	{
		...
		if (zm)
		{
			zm->GetRenderOptions()->color = ZobColor::Red;
		}
	}
	else
	{
...
void ZobEditorManager::CreateLight()
{
	...
	ret.z -= 10.0f;
	l->LookAt(&ret, false);
	ZobComponentSprite* sprite = (ZobComponentSprite*)ZobComponentFactory::CreateComponent(l, "Sprite", true);
	sprite->Init(NULL);
	sprite->SetMaterial(m_lightMaterial);
	sprite->GetRenderOptions()->lightMode = Triangle::RenderOptions::eLightMode_none;
	sprite->GetRenderOptions()->zBuffer = Triangle::RenderOptions::halfBuffered;
}

void ZobEditorManager::CreateCamera()
{
	Camera* c = DirectZob::GetInstance()->GetCameraManager()->CreateCamera(Camera::eCamera_base, m_selectedObject);
	ZobComponentSprite* sprite = (ZobComponentSprite*)ZobComponentFactory::CreateComponent(c, "Sprite", true);
	sprite->Init(NULL);
	sprite->SetMaterial(m_cameraMaterial);
	sprite->GetRenderOptions()->lightMode = Triangle::RenderOptions::eLightMode_none;
	sprite->GetRenderOptions()->zBuffer = Triangle::RenderOptions::halfBuffered;
