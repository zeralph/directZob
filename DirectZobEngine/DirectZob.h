...
namespace directZob 
{
	...
	public:
		...
		static inline DirectZob* GetInstance()
		{
			if (directZob::DirectZob::singleton == NULL)
			{
				directZob::DirectZob::singleton = new DirectZob();
			}
			return directZob::DirectZob::singleton;
		}
