...
public:
	...
	void											Start();
	void											Stop();
	void											PreUpdate(float dt, bool isPlaying);
	...
	void											RegisterOnRemoveObjectCallback(DirectZobType::OnRemoveEntityCallback cb);
...
private:
	...
	static DirectZobType::OnRemoveEntityCallback	m_onRemoveObjectCb;
}; 
