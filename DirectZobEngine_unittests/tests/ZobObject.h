...
{
	ZobObject* z = new ZobObject(ZobEntity::ZobType::type_scene, ZobEntity::ZobSubType::subtype_mesh, "zob_object");
	EXPECT_EQ(z->GetName(), "zob_object");
	EXPECT_EQ(ZobEntity::GetType(z->GetIdValue()), ZobEntity::ZobType::type_scene);
	EXPECT_EQ(ZobEntity::GetSubType(z->GetIdValue()), ZobEntity::ZobSubType::subtype_mesh);
	delete(z);
}

TEST(ZobObject, chain_parent)
{
	ZobObject* z1 = new ZobObject(ZobEntity::ZobType::type_scene, ZobEntity::ZobSubType::subtype_mesh, "zob_object_1");
	ZobObject* z2 = new ZobObject(ZobEntity::ZobType::type_scene, ZobEntity::ZobSubType::subtype_mesh, "zob_object_2");
	ZobObject* z3 = new ZobObject(ZobEntity::ZobType::type_scene, ZobEntity::ZobSubType::subtype_mesh, "zob_object_2");
	z2->SetParent(z1);
	z3->SetParent(z2);
